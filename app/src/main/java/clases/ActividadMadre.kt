...
open abstract class ActividadMadre : AppCompatActivity() {
    ...
    public fun cambiarAPantalla(nombreActividad: String): Unit {
        val intent: Intent =
            Intent(this, Class.forName("com.example.startevent." + nombreActividad))
    ...
    override fun attachBaseContext(newBase: Context) {
        val sharedPreferences =
            newBase.getSharedPreferences("preferenciasPersonalizadas", Context.MODE_PRIVATE)
        val languageCode =
            sharedPreferences.getString("idiomaElegido", Locale.getDefault().language)
